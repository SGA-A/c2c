...
class PaginationRefreshable(discord.ui.View):
    """Pagination menu with refresh support to validate the current page."""
    
    def __init__(self, interaction: discord.Interaction, get_page: Optional[Callable] = None, refresh_callback: Optional[Callable] = None) -> None:
        self.interaction = interaction
        self.get_page = get_page
    ...
    async def refresh_balance(self, interaction: discord.Interaction, _: discord.ui.Button):
        """Refresh the paginator according to what has been provided in it's instance."""
